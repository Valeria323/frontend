        ...
        <div className="card">
          ...
          >
            <div className="field">
              ...
              />
              {submitted && !ciudad.nombre && (
                <small className="p-invalid">
                  El nombre de la ciudad es necesario.
                </small>
              )}
            </div>
            <div className="field">
              ...
              />
              {submitted && !ciudad.provincia.nombre && (
                <small className="p-invalid">
                  El nombre de la provincia es necesario.
                </small>
              )}
            </div>
          </Dialog>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              />
              {ciudad && (
                <span>Está seguro de borrar las ciudades seleccionadas?</span>
              )}
            </div>
          </Dialog>
        </div>
