...
const Crud = () => {
    ...
    useEffect(() => {
        ...
        productoService.getProducto().then((data) => setProducto(data));
    }, []);
    ...
    const saveProduct = () => {
        ...
        if (producto.nombre.trim()) {
            ...
            if (producto.id) {
                ...
                const provserv = new ProductoService();
                provserv.postProducto(_product)
    ...
    const deleteProduct = () => {
        let _products = producto.filter((val) => val.id !== producto.id);
        setProducto(_products);
        setDeleteProductDialog(false);
        setProducto(emptyProducto);
        const prodserv = new ProductoService();
        prodserv.deleteProducto(producto.id);
        toast.current.show({
            severity: "success",
            summary: "Successful",
    ...
    const deleteSelectedProducts = () => {
        let _products = producto.filter((val) => !selectedProducto.includes(val));
        setProducto(_products);
        setDeleteProductsDialog(false);
